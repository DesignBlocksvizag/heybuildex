        ...
        <Container maxWidth="lg" sx={{ py: 10 }}>
          ...
          <Box textAlign="center" mb={6}>
            ...
            >
              ...
              building a dream home, commercial complex, or major
              infrastructure, we make your journey efficient and cost-effective.
            </Typography>
          </Box>
          ...
          <Grid container spacing={6} alignItems="center">
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Typography sx={bodyTextStyle}>
                ...
                <br />
                <br />
                From cement, steel, and infra equipment to heavy machinery
                rentals, we’ve got everything you need to build smarter and
                faster.
              </Typography>
            </Grid>
          </Grid>
            ...
            {[
              {
                ...
                desc: "Best brands & materials in one place.",
                icon: "🏗️",
              },
              {
                title: "Convenience",
                desc: "Compare, order & manage online easily.",
                icon: "⚡",
              },
              {
                title: "Competitive Prices",
                desc: "Unbeatable rates for maximum value.",
                icon: "💰",
              },
              {
                title: "Timely Delivery",
                desc: "Stay on schedule & on budget.",
                icon: "⏱️",
              },
            ].map((item, i) => (
              <Grid size={{ xs: 12, sm: 6, md: 3 }} key={i}>
                ...
                >
                  ...
                  <Typography
                    sx={{ color: "#555", fontSize: 14, fontFamily: "Inter" }}
                  >
                    {item.desc}
                  </Typography>
                </Box>
